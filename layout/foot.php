    ...
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 text-center">
                Copyright © <span id="year"></span> <a href="javascript:void(0)">AEEP PONGALA</a>. Develop and Designed <span
...
<script src="<?=$asset?>/plugins/snackbar/snackbar.min.js" type="text/javascript" ></script>
