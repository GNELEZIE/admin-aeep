...
<page backtop="15mm" backbottom="15mm" backleft="16mm" backright="16mm">
    <page_header>
        <table>
            <tr>
                <th class="100p border-left-radius" style="text-align: center; font-size: 30px; padding-top: 40px; padding-bottom: 40px">La liste électorale de l'AEEP</th>
            </tr>
        </table>
        <table>
            ...
            <thead>
            <tr>
                <th class="20p" style="">Photo</th>
                <th class="40p">Nom & Prénom</th>
                <th class="20p" style="">Village</th>
                <th class="20p" style="">Téléphone</th>
            </tr>
            </thead>
            ...
            while($data = $list->fetch()){
                ...
                <tr>
                    <td class="">
                        <img src="./uploads/<?=$data['photo']?>" class="myLogo" title="logo" alt="logo"/>
                    </td>
                    <td class="">
                        <?= html_entity_decode(stripslashes($data['nom'])).' '.html_entity_decode(stripslashes($data['prenom']))?>
                    </td>
                    <td class="">
